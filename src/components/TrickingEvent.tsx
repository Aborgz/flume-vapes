  ...
  return (
    <section className="py-20 px-4 relative overflow-hidden">
      ...
      <div className="container mx-auto relative z-10">
        ...
        {/* Event Banner */}
        <div className="relative rounded-xl overflow-hidden mb-12 border border-primary/30 shadow-neon-strong">
          <img 
            src={eventBanner} 
        ...
        {/* Bundle Deal */}
        <Card className="bg-gradient-card border-primary/50 shadow-neon-strong p-8 md:p-12">
