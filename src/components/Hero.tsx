...
const Hero = () => {
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      {/* Content */}
      <div className="container mx-auto px-6 md:px-8 z-10 text-center animate-slide-up">
        <h2 className="text-5xl md:text-7xl lg:text-8xl font-black mb-10 bg-gradient-cyber bg-clip-text text-transparent font-['Orbitron'] animate-glow-pulse">
          The Future is Here
        </h2>
        <p className="text-xl md:text-2xl text-foreground/80 mb-12 max-w-2xl mx-auto font-['Rajdhani'] font-light leading-relaxed">
